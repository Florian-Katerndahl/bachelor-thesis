...
streets <- st_read("C:/Users/flori/Desktop/Uni/Bachelorarbeit/city-engine/data/experiment_1_street_network.shp", quiet = TRUE)
...
write.table(tree_coords, "C:/Users/flori/Desktop/Uni/Bachelorarbeit/city-engine/data/experiment_1_tree_attributes.txt",
