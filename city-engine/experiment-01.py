...
def experiment_1():
    """
    ESRI street, LumenRT models, no geometry variation
    """
    ...
    scene.export_as_shape_file("streets", "C:\\Users\\flori\\Desktop\\Uni\\Bachelorarbeit\\city-engine\\data\\experiment_1_street_network.shp")
    
    _ = input("run R script\n")
    
    scene.place_street_trees("C:\\Users\\flori\\Desktop\\Uni\\Bachelorarbeit\\city-engine\\assets\\assets\\Plants\\**\\*Model_0.obj", "C:\\Users\\flori\\Desktop\\Uni\\Bachelorarbeit\\city-engine\\data\\experiment_1_tree_attributes.txt")
    ...
    scene.gather_tree_images("trees", vp, "C:\\Users\\flori\\Desktop\\Uni\\Bachelorarbeit\\city-engine\\images\\experiment_1", "city_trees.png", 512, "C:\\Users\\flori\\Desktop\\Uni\\Bachelorarbeit\\city-engine\\images\\experiment_1\\meta.csv", mean_height=120.0, mean_height_sd=0.0,
