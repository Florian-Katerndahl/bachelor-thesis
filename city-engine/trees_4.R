...
streets <- st_read("C:/Users/katerndaf29/Documents/CityEngine/Default Workspace/bachelor/data/experiment_6_street_network.shp", quiet = TRUE)
...
write.table(tree_coords, "C:/Users/katerndaf29/Documents/CityEngine/Default Workspace/bachelor/data/experiment_6_tree_attributes.txt",
